...
const GCSE_LISTENINGS = [
  ...
  {
    id:'gcse_listen_family',
    title:'Mi familia',
    tier:'foundation',
    level:'B1',
    theme:'People and lifestyle',
    icon:'👨‍👩‍👧',
    speaker:'Sofía, 15, describes her family in Valencia',
    replayLimit:2,
    script:'En mi familia somos cinco personas: mis padres, mis dos hermanos y yo. Mi padre se llama Juan y trabaja como médico en un hospital. Mi madre, María, es profesora de inglés en un instituto. Tengo un hermano mayor que se llama Pablo. Tiene veinte años y estudia en la universidad. Mi hermana pequeña, Lucía, solo tiene siete años. Me llevo muy bien con Lucía aunque a veces es un poco molesta. Los fines de semana, normalmente cenamos juntos en casa.',
    transcript:'En mi familia somos cinco personas: mis padres, mis dos hermanos y yo. Mi padre se llama Juan y trabaja como médico en un hospital. Mi madre, María, es profesora de inglés en un instituto. Tengo un hermano mayor que se llama Pablo. Tiene veinte años y estudia en la universidad. Mi hermana pequeña, Lucía, solo tiene siete años. Me llevo muy bien con Lucía aunque a veces es un poco molesta. Los fines de semana, normalmente cenamos juntos en casa.',
    questions:[
      {type:'mc',q:'How many people are in Sofía\'s family?',opts:['Four','Five','Six','Seven'],correct:1},
      {type:'mc',q:'What does her father do?',opts:['Teacher','Doctor','Engineer','Lawyer'],correct:1},
      {type:'fill',q:'Her mother teaches __________.',answer:'English',hint:'inglés'},
      {type:'tf',q:'Sofía\'s older brother is still at school.',correct:false,explanation:'Pablo "estudia en la universidad" — he studies at university.'},
      {type:'mc',q:'How does Sofía feel about her younger sister?',opts:['They never get on','They get on well, even if sometimes annoying','They are best friends with no problems','They rarely see each other'],correct:1}
    ]
  },
  {
    id:'gcse_listen_holiday',
    title:'Mis vacaciones',
    tier:'foundation',
    level:'B1',
    theme:'My personal world',
    icon:'🏖️',
    speaker:'Tomás, 16, talks about his summer holiday',
    replayLimit:2,
    script:'El verano pasado fui de vacaciones a Mallorca con mi familia. Pasamos dos semanas en un hotel cerca de la playa. El primer día, hacía mucho calor y fuimos directamente a nadar en el mar. Cada mañana, desayunábamos en el hotel y luego íbamos a la piscina. Por la noche, salíamos a cenar en restaurantes diferentes. Mi plato favorito era la paella. Lamentablemente, perdí mi móvil el último día. Pero, en general, fue una experiencia fantástica y quiero volver el próximo año.',
    transcript:'El verano pasado fui de vacaciones a Mallorca con mi familia. Pasamos dos semanas en un hotel cerca de la playa. El primer día, hacía mucho calor y fuimos directamente a nadar en el mar. Cada mañana, desayunábamos en el hotel y luego íbamos a la piscina. Por la noche, salíamos a cenar en restaurantes diferentes. Mi plato favorito era la paella. Lamentablemente, perdí mi móvil el último día. Pero, en general, fue una experiencia fantástica y quiero volver el próximo año.',
    questions:[
      {type:'mc',q:'Where did Tomás go on holiday?',opts:['Barcelona','Mallorca','Madrid','Málaga'],correct:1},
      {type:'mc',q:'How long was the holiday?',opts:['One week','Ten days','Two weeks','A month'],correct:2},
      {type:'fill',q:'On the first day, the weather was very __________.',answer:'hot',hint:'hacía mucho calor'},
      {type:'tf',q:'They ate dinner at the hotel every night.',correct:false,explanation:'"restaurantes diferentes" — they went to different restaurants.'},
      {type:'mc',q:'What happened on the last day?',opts:['They went home early','He lost his phone','It rained heavily','He got sick'],correct:1}
    ]
  },
  {
    id:'gcse_listen_food',
    ...
    theme:'Communication and the world around us',
    icon:'🥗',
    speaker:'Carmen, 16, talks about her eating habits',
    replayLimit:2,
    script:'Intento llevar una dieta bastante sana. Normalmente desayuno cereales con leche y una fruta, como un plátano o una manzana. Para el almuerzo, suelo comer una ensalada o un sándwich con pollo. La verdad es que no me gustan mucho las verduras, pero sé que son importantes. Mi madre cocina pescado tres veces a la semana, lo cual es muy bueno para la salud. Los fines de semana, sin embargo, me encanta comer pizza o hamburguesas con mis amigos. Bebo mucha agua durante el día y rara vez tomo bebidas con azúcar.',
    transcript:'Intento llevar una dieta bastante sana. Normalmente desayuno cereales con leche y una fruta, como un plátano o una manzana. Para el almuerzo, suelo comer una ensalada o un sándwich con pollo. La verdad es que no me gustan mucho las verduras, pero sé que son importantes. Mi madre cocina pescado tres veces a la semana, lo cual es muy bueno para la salud. Los fines de semana, sin embargo, me encanta comer pizza o hamburguesas con mis amigos. Bebo mucha agua durante el día y rara vez tomo bebidas con azúcar.',
    questions:[
      {type:'mc',q:'What does Carmen usually have for breakfast?',opts:['Toast and coffee','Cereal with milk and fruit','Eggs and bacon','Just water'],correct:1},
      {type:'tf',q:'Carmen loves vegetables.',correct:false,explanation:'"no me gustan mucho las verduras" — she doesn\'t like vegetables much.'},
      {type:'fill',q:'Her mother cooks fish __________ times a week.',answer:'three',hint:'tres veces'},
      {type:'mc',q:'What does she eat at weekends?',opts:['Salads','Fish','Pizza or burgers','Soup'],correct:2},
      {type:'mc',q:'What does she drink during the day?',opts:['Coffee','Sugary drinks','A lot of water','Fruit juice'],correct:2}
    ]
  },
  {
    id:'gcse_listen_technology',
    title:'La tecnología en mi vida',
    tier:'higher',
    level:'B2',
    theme:'People and lifestyle',
    icon:'📱',
    speaker:'Andrés, 17, reflects on the role of technology',
    replayLimit:2,
    script:'No puedo imaginarme la vida sin la tecnología, aunque reconozco que tiene aspectos negativos. Paso unas tres horas al día en mi móvil, principalmente chateando con mis amigos por WhatsApp y viendo vídeos en TikTok. Sin embargo, mis padres se quejan constantemente de que estoy enganchado a la pantalla. Quizás tengan razón. He notado que duermo peor si uso el móvil antes de acostarme. Por eso, desde hace un mes, intento dejarlo en la cocina por la noche. Lo que más me preocupa es que, hoy en día, mucha gente prefiere mandar mensajes en vez de hablar cara a cara.',
    transcript:'No puedo imaginarme la vida sin la tecnología, aunque reconozco que tiene aspectos negativos. Paso unas tres horas al día en mi móvil, principalmente chateando con mis amigos por WhatsApp y viendo vídeos en TikTok. Sin embargo, mis padres se quejan constantemente de que estoy enganchado a la pantalla. Quizás tengan razón. He notado que duermo peor si uso el móvil antes de acostarme. Por eso, desde hace un mes, intento dejarlo en la cocina por la noche. Lo que más me preocupa es que, hoy en día, mucha gente prefiere mandar mensajes en vez de hablar cara a cara.',
    questions:[
      {type:'mc',q:'How long does Andrés spend on his phone daily?',opts:['About 1 hour','About 2 hours','About 3 hours','About 5 hours'],correct:2},
      {type:'tf',q:'Andrés disagrees completely with his parents\' concerns.',correct:false,explanation:'"Quizás tengan razón" — perhaps they are right.'},
      {type:'mc',q:'What change has he made recently?',opts:['Deleted social media','Bought a new phone','Leaves phone in the kitchen at night','Stopped texting friends'],correct:2},
      {type:'fill',q:'He sleeps __________ if he uses his phone before bed.',answer:'worse',hint:'peor'},
      {type:'mc',q:'What worries him MOST about technology?',opts:['Privacy and data','People prefer messages over face-to-face','Children using phones too young','Phone addiction in adults'],correct:1}
    ]
  },
  {
    id:'gcse_listen_health',
    title:'Llevar una vida sana',
    tier:'higher',
    level:'B2',
    theme:'My personal world',
    icon:'💪',
    speaker:'Isabel, 18, on the pressures of staying healthy as a student',
    replayLimit:2,
    script:'Para mí, llevar una vida sana siempre ha sido un desafío, sobre todo desde que empecé el bachillerato. Estoy tan ocupada con los estudios que apenas tengo tiempo para hacer ejercicio. Antes iba al gimnasio tres veces a la semana, pero ahora suelo ir solamente una vez. Lo peor es que, cuando estoy estresada, como demasiado chocolate. Sé que no es bueno, pero me ayuda a relajarme. Mi médico me ha recomendado dormir al menos ocho horas cada noche, aunque rara vez lo consigo. Si pudiera cambiar una cosa, dejaría de tomar tantos cafés porque me ponen muy nerviosa.',
    transcript:'Para mí, llevar una vida sana siempre ha sido un desafío, sobre todo desde que empecé el bachillerato. Estoy tan ocupada con los estudios que apenas tengo tiempo para hacer ejercicio. Antes iba al gimnasio tres veces a la semana, pero ahora suelo ir solamente una vez. Lo peor es que, cuando estoy estresada, como demasiado chocolate. Sé que no es bueno, pero me ayuda a relajarme. Mi médico me ha recomendado dormir al menos ocho horas cada noche, aunque rara vez lo consigo. Si pudiera cambiar una cosa, dejaría de tomar tantos cafés porque me ponen muy nerviosa.',
    questions:[
      {type:'mc',q:'How often does Isabel go to the gym NOW?',opts:['Every day','Three times a week','Once a week','Never'],correct:2},
      {type:'mc',q:'What does she do when stressed?',opts:['Goes for a run','Eats too much chocolate','Calls a friend','Watches TV'],correct:1},
      {type:'fill',q:'Her doctor recommends sleeping at least __________ hours a night.',answer:'eight',hint:'ocho horas'},
      {type:'tf',q:'Isabel always manages to follow her doctor\'s advice.',correct:false,explanation:'"rara vez lo consigo" — she rarely manages it.'},
      {type:'mc',q:'What would she change if she could?',opts:['Eat less chocolate','Sleep more','Drink less coffee','Exercise more'],correct:2}
    ]
  },
  {
    id:'gcse_listen_town',
    ...
    theme:'Communication and the world around us',
    icon:'🏙️',
    speaker:'Mateo, 17, on life in a small town vs. a big city',
    replayLimit:2,
    script:'Vivo en un pueblo pequeño en el norte de España, a unos cincuenta kilómetros de Bilbao. Por un lado, me encanta porque es muy tranquilo y conozco a todo el mundo. El paisaje es precioso y el aire mucho más limpio que en una ciudad grande. Por otro lado, hay muy pocas cosas que hacer para los jóvenes. No hay cine ni centro comercial, y los autobuses a Bilbao solo pasan tres veces al día. Si pudiera elegir, me trasladaría a una ciudad grande durante mis estudios universitarios, y luego volvería al pueblo cuando fuera más mayor para criar a una familia.',
    transcript:'Vivo en un pueblo pequeño en el norte de España, a unos cincuenta kilómetros de Bilbao. Por un lado, me encanta porque es muy tranquilo y conozco a todo el mundo. El paisaje es precioso y el aire mucho más limpio que en una ciudad grande. Por otro lado, hay muy pocas cosas que hacer para los jóvenes. No hay cine ni centro comercial, y los autobuses a Bilbao solo pasan tres veces al día. Si pudiera elegir, me trasladaría a una ciudad grande durante mis estudios universitarios, y luego volvería al pueblo cuando fuera más mayor para criar a una familia.',
    questions:[
      {type:'mc',q:'How far is Mateo\'s town from Bilbao?',opts:['15 km','30 km','50 km','100 km'],correct:2},
      {type:'mc',q:'What does he like MOST about his town?',opts:['The shops','The peace and quiet','The bus service','The young people'],correct:1},
      {type:'fill',q:'Buses to Bilbao only pass __________ times a day.',answer:'three',hint:'tres veces'},
      {type:'tf',q:'Mateo wants to stay in his town forever.',correct:false,explanation:'He says he would move to a big city for university first.'},
      {type:'mc',q:'When would he return to the town?',opts:['Never','After university','To raise a family','For holidays only'],correct:2}
    ]
  }
